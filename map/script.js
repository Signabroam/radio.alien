...
var web888Icon = new L.Icon({
    iconUrl: 'https://i.postimg.cc/FsfqWyh5/web-888-51x60.png',
    iconSize: [30, 41],
    iconAnchor: [12, 41],
    popupAnchor: [1, -34]
});
...
var owrIcon = new L.Icon({
    iconUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThPm7O_FyS8fWEJTZhmaKEUzGlvU34HpkxWg&s',
    iconSize: [30, 30],
    iconAnchor: [12, 41],
    popupAnchor: [1, -34]
});
